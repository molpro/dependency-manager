...
function(DependencyManager_Populate name)
    ...
    message("${${lcName}_SOURCE_DIR}/.dependency_manager_SHA")
    if(EXISTS "${${lcName}_SOURCE_DIR}/.dependency_manager_SHA")
    file(READ "${${lcName}_SOURCE_DIR}/.dependency_manager_SHA" __SHA_FILE)
    ...
    if (NOT ${lcName}_POPULATED)
        ...
        if (NOT DEFINED __SHA_FILE OR NOT __SHA_FILE STREQUAL __SHA)
            message("call FetchContent_MakeAvailable")
            FetchContent_MakeAvailable(${name})
        else()
            message("not calling FetchContent_MakeAvailable")
        endif ()
        ...
        message("source_dir ${${lcName}_SOURCE_DIR}")
        execute_process(COMMAND git -C "${${lcName}_SOURCE_DIR}" rev-parse HEAD OUTPUT_VARIABLE __SHA)
        message("__SHA ${__SHA}")
        file(WRITE "${${lcName}_SOURCE_DIR}/.dependency_manager_SHA" ${__SHA})
        message("unlocking ${lockfile}$")
        execute_process(COMMAND "date")

...
function(DependencyManager_Populate name)
    ...
    set(shafile "${STAMP_DIR}/._private_dependencymanager_${name}-SHA")
    ...
    if (NOT ${lcName}_POPULATED)
        ...
        if (EXISTS "${${lcName}_SOURCE_DIR}")
            message("source_dir exists: ${${lcName}_SOURCE_DIR}")
            execute_process(COMMAND git -C "${${lcName}_SOURCE_DIR}" rev-parse HEAD OUTPUT_VARIABLE __SHA)
            message("__SHA ${__SHA}")
            file(WRITE "${shafile}" ${__SHA})
        endif ()
    endif ()

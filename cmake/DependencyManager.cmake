...
function(DependencyManager_Lock)
    file(LOCK "${CMAKE_SOURCE_DIR}/dependencies" DIRECTORY GUARD PROCESS TIMEOUT 1000 RESULT_VARIABLE _lock_result) # don't allow multiple instances of cmake because of population of dependencies
#    get_property(Declare_has_run_ GLOBAL PROPERTY Declare_has_run)
#    message("Property Declare_has_run_ ${Declare_has_run}")
#    if (ON OR NOT Declare_has_run)
...
#    message("Locking ${lockfile} at ${time_}")
    ...
    if (NOT ${lcName}_POPULATED)
        ...
        message("${lcName} population finished")
    else()
        message("${lcName} is already populated")
    endif ()
    string(TIMESTAMP time_)
#    message("Unlocking ${lockfile} at ${time_}")
